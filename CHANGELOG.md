...
- Enh: Insert images by URL or file upload; images are stored as standard HTML

## 1.0.0 — 2026-08-14

First public release of Thiscovery Editor.

- Enh: Lexical editor with headings, lists, links, callout, accordion, survey, and button blocks
- Enh: HTML source view (toolbar HTML button) plus preservation of tables, iframes, and other raw markup
- Used by Thiscovery Page Builder in place of TinyMCE
